...
def test_listing_repository_returns_listing_with_id(db_connection):
    ...
    listing = Listing(1, 'Uncomfortable camper van in a lay-by', 'Newtown', 21, '01-01-2026', '31-01-2026', 2)

    repository = ListingRepository(db_connection)

    assert listing == repository.find_listing_by_id(2)
...
def test_listing_adds_new_listing(db_connection):
    ...
    listing = Listing(1, 'Palacial shed in a field', 'Idyllicville', 1010, '01-01-2026', '31-01-2026', 13)
